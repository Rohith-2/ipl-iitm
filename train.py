...
ylist = y.tolist()
ylist.extend([26,32,46,45,55,39,32,55,54,45,32,59,21,45,25,50,51,65,51,56,37,42,36,43,39,50,47,49,45,67])
y = np.array(ylist)
...
p = players.tolist()
p.extend(["Jhye Richardson","Chetan Sakariya","Fabian Allen",'Riley Meredith',"_"])
players = np.array(p)
